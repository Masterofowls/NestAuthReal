...
function App() {
  ...
  const [requestedAuth, setRequestedAuth] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    const unsubAuth = window.onAuthenticated((u) => {
      ...
      addLog("success", `Authenticated: ${u.email}`);
    });
    const unsubError = window.onAuthError((ctx) => {
      addLog("error", `Auth error: ${ctx.message ?? "unknown"}`);
    });
    const unsubUpdate = window.onUserUpdated((u) => {
      setUser(u);
      addLog("info", `User updated: ${u.email}`);
    });
    return () => {
      unsubAuth();
      unsubError();
  ...
  const handleRequestAuth = (provider) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.root, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.header, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.headerTitle, children: "NestAuth" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.badge, children: "Electron Testing Client" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.body, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.panel, children: [
      user ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.card, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.cardTitle, children: "Active Session" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.userRow, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.avatar, children: user.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: user.image,
              alt: "avatar",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.userInfo, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.userName, children: user.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.userEmail, children: user.email }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.userId, children: [
              "ID: ",
              user.id
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.row, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      !user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.card, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.cardTitle, children: "Sign In" }),
      ...
      requestedAuth && !user && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
            ...styles.card,
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, fontWeight: 600, color: "#93c5fd", marginBottom: 4 }, children: "Waiting for browser sign-in…" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "#475569" }, children: "Complete sign-in in your browser — you'll be redirected back automatically." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.card, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...styles.cardTitle, marginBottom: 12 }, children: "Activity Log" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.logs, children: [
          logs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#475569" }, children: "No events yet." }),
          [...logs].reverse().map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.logEntry, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#475569" }, children: [
              "[",
              entry.ts,
              "] "
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles[`log${entry.type.charAt(0).toUpperCase()}${entry.type.slice(1)}`], children: entry.msg })
          ] }, i))
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.card, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.cardTitle, children: "Debug Info" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "pre",
          {
            style: {
    ...
    if (this.state.error) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { marginBottom: 16 }, children: "Renderer Error" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("pre", { style: { whiteSpace: "pre-wrap", wordBreak: "break-all" }, children: [
